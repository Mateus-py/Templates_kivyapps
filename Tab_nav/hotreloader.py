...
class Tab_nav(MDApp, HotReloaderApp):  # NOQA: N801
    ...
    CLASSES = {'Root': 'libs.uix.baseclass.root', 'HomeScreen': 'libs.uix.baseclass.home_screen', 'TabOne': 'libs.uix.baseclass.tab_one', 'TabTwo': 'libs.uix.baseclass.tab_two', 'TabThree': 'libs.uix.baseclass.tab_three'}  # NOQA: F821
    ...
    def __init__(self, **kwargs):
        super(Tab_nav, self).__init__(**kwargs)
