...
class Backdrop(MDApp, HotReloaderApp):  # NOQA: N801
    ...
    CLASSES = {'Root': 'libs.uix.baseclass.root', 'HomeScreen': 'libs.uix.baseclass.home_screen', 'BackdropBackLayer': 'libs.uix.baseclass.bd_back_layer', 'BackdropFrontLayer': 'libs.uix.baseclass.bd_back_layer'}  # NOQA: F821
